...
struct ElectricityBillView: View {
   ...
   @ObservedObject var viewModel: PaymentViewModelImpl
    @State private var selectedBill: ElectricityBill = ElectricityBill(name: "", number: "", planType: .prepaid)
    @State private var selectedProvider: ElectricityProvider = ElectricityProvider(name: "")
    @State private var selectedPlan: ElectricityPlan = ElectricityPlan(name: "")
